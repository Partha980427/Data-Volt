...
def get_socket_head_dimensions(standard, product, size, grade="All"):
    """Get head diameter and head height for socket head products from database"""
    try:
        # Get the appropriate dataframe based on standard
...
def calculate_socket_product_weight_rectified(parameters, head_diameter, head_height, original_unit):
    ...
    try:
        ...
        # 2. Calculate Head Volume: 0.7853 × (Head Diameter)² × Head Height
    ...
    with st.sidebar:
        ...
        with st.expander("RECTIFIED Weight Calculator Guide"):
            ...
            **RECTIFIED FORMULAS:**
            ...
            - **Socket Head Volume:** 0.7853 × (head_diameter)² × head_height (mm³)
            - **Countersunk Head Volume:** 0.7853 × (head_diameter)² × head_height (mm³)
